...
--
-- Client :  127.0.0.1
-- Généré le :  Dim 28 Juin 2015 à 19:22
...
(1, 'contenu de commentaire', 3, 5, 0),
(4, 'commentaire 2', 6, 5, 0),
...
--
ALTER TABLE `contribution`
  MODIFY `id_contribution` int(50) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=12;
--
